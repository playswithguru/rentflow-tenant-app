  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-900">Access not granted</h1>
...
export default function RentFlowGate() {
  ...
  if (!user) {
    return <AccessDenied message="Please sign in to continue." />;
  }
...
const hasDashboardAccess =
  ...
  if (!hasDashboardAccess) {
    return <AccessDenied message="Dashboard access is not enabled for this account." />;
  }
